<%-- 
    Document   : index
    Created on : Nov 21, 2018, 10:06:10 PM
    Author     : DELL
--%>
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="index.jsp"><img src="main/img/logo_1.png" alt="" title="" height="90" width="150"/></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="#contact">Contact</a></li>	
                                          <li class="menu-has-children"><a style="color:white">Welcome Riders</a>
				            <ul>
					...
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-7 col-md-6 ">
							...
							<h1 class="text-white text-uppercase">
                                                            with EasyWay<br>Welcome Riders !
							</h1>
							<h6 class="pt-20 pb-20 text-white">
                                                            Drive to earn money or ride easy now<br>
							</h6>
							<a href="login.html" class="primary-btn text-uppercase">Find a Ride</a>
                                                        <a href="login.html" class="primary-btn text-uppercase">Offer a Drive</a>
					...
					<div class="active-model-carusel">
						<div class="row align-items-center single-model item">
							<div class="col-lg-6 model-left">
								...
								<a class="text-uppercase primary-btn" href="login.html">Get This Ride Now</a>
							</div>
