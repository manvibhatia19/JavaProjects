<%-- 
    Document   : drivers
    Created on : Nov 22, 2018, 12:08:19 AM
    Author     : DELL
--%>
			  ...
			  <header id="header" id="home">
			    <div class="container">
			    	<div class="row align-items-center justify-content-between d-flex">
				      <div id="logo">
				        <a href="drivers.jsp"><img src="main/img/logo_1.png" alt="" title="" height="60" width="120"/></a>
				      </div>
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          <li class="menu-active"><a href="drivers.jsp">Home</a></li>
				          <li><a href="#about">About</a></li>
                                          <li><a href="#service">Services</a></li>
                                          <li><a href="#rides">Rides</a></li>
                                          <li><a href="#history">Drives History</a></li>
                                          <li><a href="history.jsp">Untaken</a></li>
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						...
						<div class="col-lg-5  col-md-6 header-right">
							<h4 class="text-white pb-30">Offer Your Drive Today!</h4>
							<form class="form" role="form" action="drives.jsp" method="post">
							    ...
							    <div class="from-group row">
							    	...
							    	<input class="form-control txt-field" type="text" name="phone" placeholder="Phone number">
                                                                ...
                                                                <input class="form-control txt-field" type="text" name="halt1" placeholder="Halt if any">
                                                                <input class="form-control txt-field" type="text" name="halt2" placeholder="Another Halt if any">
                                                                <input class="form-control txt-field" type="text" name="seats" placeholder="No. of Seats Available">
							    </div>
                                                            <div class="form-group row">
                                                                <div class="col-md-6 wrap-left">
										<div class="input-group dates-wrap">                                          
											<input id="datepicker" class="dates form-control" id="exampleAmount" placeholder="Date of Drive" type="date" name="ddate">                        
										...
										<div class="input-group times-wrap">                                          
											<input id="timepicker" class="times form-control" id="exampleAmount" placeholder="Time of Drive" type="time" name="dtime">                        
											<div class="input-group-prepend">
							    ...
							    <div class="form-group row">
							        <div class="col-md-12">
							            <button type="submit" class="btn btn-default btn-lg btn-block text-center text-uppercase">Offer Drive</button>
							        </div>
							    </div>
							</form>
						</div>											
			...
			<section class="reviews-area section-gap" id="history">
				<div class="container">
						...
						<div class="col-md-8 pb-40 header-text text-center">
							<h1>Successful Drives History</h1>
							<p class="mb-10 text-center">
								Who are in extremely love with motion friendly system.
                                    ...
                                    <% String uname=(String)session.getAttribute("username");
                                        String url="jdbc:mysql://localhost:3306/easyway";
                                            ...
                                            String query="select * from drives where username='"+uname+"'";
                                            ...
                                            { %>
                                                <div class="col-lg-4 col-md-6">
                                                        <div class="single-review">
                                                            <h4>Drive Details: No Drives Yet !</h4>
                                                        </div>
                                                </div>
                                            <% }
								...
								<p>
                                                                    ...
                                                                    Halt 1: <%=rs2.getString("halt1")%><br>
                                                                    Halt 2: <%=rs2.getString("halt2")%><br>
                                                                    No. of Seats available: <%=rs2.getString("seats")%><br>
                                                                    Drive Date: <%=rs2.getString("ddate")%><br>
                                                                    Drive Time: <%=rs2.getString("dtime")%>
								</p>
								<div class="star">
