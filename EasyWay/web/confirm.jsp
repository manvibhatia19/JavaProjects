<%-- 
    Document   : confirm
    Created on : Nov 28, 2018, 3:34:27 AM
    Author     : DELL
--%>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="history.jsp">Drives History </a>  <span class="lnr lnr-arrow-right"></span>  <a href="confirm.jsp"> Confirmed Drives</a></p>
						</div>											
					</div>
                        </section>
						...
						<div class="col-md-8 pb-40 header-text">
                                                        <h1><span class="lnr lnr-lock"></span>Your Drive is Confirmed !</h1>
						</div>
					</div>
				</div>
			</section>
