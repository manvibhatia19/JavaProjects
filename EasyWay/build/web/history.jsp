<%-- 
    Document   : history
    Created on : Nov 28, 2018, 1:30:30 AM
    Author     : DELL
--%>
				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="drivers.jsp">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="history.jsp"> Drives History</a></p>
						</div>											
					</div>
				</div>
			</section>
				...
				<div class="container">
					<div class="row d-flex justify-content-center">
                        ...
                        <div class="row">
                                            ...
                                            String halt1=(String)session.getAttribute("halt2");
                                            String halt2=(String)session.getAttribute("halt1");
                                        ...
                                        String url="jdbc:mysql://localhost:3306/easyway";
                                            ...
                                            String query="select * from seats where pickup='"+pickup+"' OR pickup='"+halt1+"' OR pickup='"+halt2+"' AND dropoff='"+dropoff+"' AND seats<='"+seats+"'";
							...
							<div class="single-feature">
                                                            <h4><span class="lnr lnr-car"></span>Rider: No Riders Untaken !</h4>
							</div>
                                                </div>
                                            <% }
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-feature">
                                                            <h4><span class="lnr lnr-car"></span>Rider: <%=rs2.getString("name")%></h4>
								<p>
                                                                    ...
                                                                    Ride Time: <%=rs2.getString("rtime")%><br>
                                                                    <span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star checked"></span>
									<span class="fa fa-star-half-o"></span>
									<span class="fa fa-star-o"></span>
                                                                    <a href="confirm.jsp"><b>Confirm Now</b></a>
								</p>
							</div>
						</div>
                                            <% }
